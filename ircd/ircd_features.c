...
static struct FeatureDesc {
  ...
  F_S(HIS_SERVERINFO, 0, "Astrolink IRC Network", feature_notify_serverinfo),
  F_S(HIS_URLSERVERS, 0, "http://www.astrolink.org/", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "Astrolink", set_isupport_network),
  F_S(URL_CLIENTS, 0, "http://www.ircreviews.org/clients/", 0),
  F_S(URLREG, 0, "http://www.astrolink.org/", 0),
